...
# file_path = "/home/kayadev-gpu-2/Desktop/aug_scripts/annotations/20.xml"

data_path = "\\home\\harish\\Desktop\\videosforabg\\HMV\\"
img_path = "\\home\\harish\\Desktop\\videosforabg\\HMV\\"
xml_path = "\\home\\harish\\Desktop\\videosforabg\\HMV\\annotations\\"
...
# if you specify range(2) total number of augmented data is 12 for one image
        for color in range(1):
            ...
            ang_x1 = w - x2
            # print("aaannnnggggggg______xxxxx11111111",str(ang_x1))
            ang_y1 = h - y2
            ang_x2 = w - x1
            ang_y2 = h - y1
            ...
            # tree.write("C:\\Users\\Manas\\Desktop\\test_abg\\annotations\\{}.xml".format(color_name))
            et.write(xml_file)
